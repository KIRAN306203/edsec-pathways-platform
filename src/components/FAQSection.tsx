...
const faqs = [
  ...
  },
  {
    ...
    answer: 'New batches are starting from 1st March 2026. We offer flexible batch timings to accommodate students and working professionals. Contact us for the latest batch schedule.',
  },
  {
